...
def get_dns(file_location):
	...
	print("DNS2:\t\t\t" + split_line2[1].strip())

	os.system("echo 'DNS1:' >> " + file_location)
	os.system("echo '" + split_line1[1].strip() + "' >> " + file_location)
	os.system("echo '\n' >> " + file_location)
	os.system("echo 'DNS2:' >> " + file_location)
	os.system("echo '" + split_line2[1].strip() + "' >> " + file_location)
	os.system("echo '\n' >> " + file_location)
...
def get_total_ram(file_location):
	...
	with open("ram.txt") as file:
		line = file.readline()
	split_line = line.split(" ")
	print("Total RAM:\t\t" + split_line[8].strip())
	os.system("rm ram.txt")

	os.system("echo 'Total RAM:' >> " + file_location)
	os.system("echo '" + split_line[8].strip() + "' >> " + file_location)
	os.system("echo '\n' >> " + file_location)
...
def get_available_ram(file_location):
	...
	with open("ram.txt") as file:
		line = file.readline()
	split_line = line.split(" ")
	print("Available RAM:\t\t" + split_line[22].strip())
	os.system("rm ram.txt")

	os.system("echo 'Available RAM:' >> " + file_location)
	os.system("echo '" + split_line[22].strip() + "' >> " + file_location)
	os.system("echo '\n' >> " + file_location)
